...
[BASE] = LAYOUT_ergodox(
  ...
  KC_LGUI,   XXXXXXX,  XXXXXXX,   LT(MOVE, KC_NO), KC_MINS,
                                                           KC_LALT,          KC_HOME,
                                                                             KC_END,
  ...
  XXXXXXX,   KC_N,    KC_M,      KC_COMM,    KC_DOT,     LT(MOVE, KC_SLSH),   KC_RSFT,
